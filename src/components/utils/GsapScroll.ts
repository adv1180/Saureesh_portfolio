  ...
  if (window.innerWidth > 1024) {
    if (character) {
      tl1
        ...
        // Properly shift the 3D model natively instead of DOM hacking
        .fromTo(character.position, { x: 0 }, { x: -2, duration: 1 }, 0)
      ...
      tl2
        ...
        .to(character.position, { x: -1, y: -2, delay: 3, duration: 3 }, 0) // shift further down/left on scroll
